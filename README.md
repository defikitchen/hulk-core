...
- Hulkfather - https://etherscan.io/address/0xdeadbeef
- (Uni|Token)swapV2Factory - https://etherscan.io/address/0xdeadbeef
- (Uni|Token)swapV2Router02 - https://etherscan.io/address/0xdeadbeef
- (Uni|Token)swapV2Pair init code hash - `deadbeef`
- HulkBoat - https://etherscan.io/address/0xdeadbeef
- HulkMaker - https://etherscan.io/address/0xdeadbeef

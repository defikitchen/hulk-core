...
module.exports = {
  ...
  networks: {
    ...
    goerli: {
      provider: () => new HDWalletProvider(
        secrets.mnemonic,
        `https://goerli.infura.io/v3/${secrets.infuraApiKey}`,
        0,
        3
      ),
      network_id: 5,
    ...
    kovan: {
      provider: () => new HDWalletProvider(
        secrets.mnemonic,
        `https://kovan.infura.io/v3/${secrets.infuraApiKey}`,
        0,
        3
      ),
      skipDryRun: true,
    ...
    mainnet_fork: {
      provider: () => new HDWalletProvider(
        secrets.mnemonic,
        `https://mainnet-fork.infura.io/v3/${secrets.infuraApiKey}`,
        0,
        3
      ),
      gas: 7000000,
  ...
  compilers: {
    solc: {
      ...
      settings: { // See the solidity docs for advice about optimization and evmVersion
        ...
        // evmVersion: "constantinople" // cannot use
      }
    }
  }
}